...
#     all_data = scale_features(all_data, save_path=output_dir)
...
#     print("Files saved: processed_train.csv, processed_test.csv, scaler.pkl, correlation_matrix.png, saleprice_distribution.png")
...
def handle_collinearity(df, high_correlations, target_column='SalePrice'):
    features_to_drop = set()
    protected_features = {'TotalSF', 'GrLivArea'}  # don't drop these!

    for corr in high_correlations:
        if corr['feature1'] in features_to_drop or corr['feature2'] in features_to_drop:
            continue

        # Protect features from being dropped
